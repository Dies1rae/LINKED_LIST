...
void Test1() {
    //Spy to look for delete (PRECODED)
    struct DeletionSpy {
        DeletionSpy() = default;
    ...
    // Exception class throwing except after N-copy
    struct ThrowOnCopy {
        ThrowOnCopy() = default;
...
//iterator basic func tests
void Test2() {
    //iterating in empty list
    {
...
void Test3() {
    ...
    //  initializer_list constructor test
    {
...
//iterators before_begin and insert-delete tests
void Test4() {
    struct DeletionSpy {
        ~DeletionSpy() {
...
void All_Tests() {
    std::cout << "Test started:"s << std::endl;
    std::cout << "-basic function tests-"s << std::endl;
    Test1();
    std::cout << "-OK-"s << std::endl;
    std::cout << "-iterator basic func tests-"s << std::endl;
    Test2();
    std::cout << "-OK-"s << std::endl;
    std::cout << "-basic list func tests-"s << std::endl;
    Test3();
    std::cout << "-OK-"s << std::endl;
    std::cout << "-iterators before_begin and insert-after, delete tests-"s << std::endl;
    Test4();
    std::cout << "-OK-"s << std::endl;
    std::cout << "All test passed = OK!"s << std::endl;
}